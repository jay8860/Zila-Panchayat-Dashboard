...
const AiSearch = ({ isOpen, onClose, onOpen }) => {
    ...
    if (!isOpen) {
            return (
                <button
                    onClick={onOpen}
                    className="fixed top-6 right-6 h-12 w-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full shadow-2xl flex items-center justify-center text-white hover:scale-110 transition-transform z-[9999] animate-in fade-in zoom-in"
